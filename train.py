...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # 获得记录训练日志的路径
    """
    训练日志包括：权重、tensorboard文件，超参数hyp、设置的训练参数opt(也就是epochs,batch_size等)
    result.txt包括：占GPU内存、训练集的GIOU loss, objectness loss, classification loss, 总loss，targets的数量，输入图片分辨率，准确率TP/(TP+FP)，召回率TP/P
    """
